...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div id="Required" class="custom-container d-flex justify-content-center" runat="server">
        ...
        <ul class="list-group list-group-flush">
            <asp:DataList ID="FollowersDataList" ItemType="Es.Udc.DotNet.PracticaMaD.Model.UserService.UserProfileDetails" OnItemDataBound="FollowsDataList_ItemDataBound" runat="server">
                <ItemTemplate>
                    <li class="list-group-item bg-light">
                        <div class="row justify-content-center">
                            <div class="input-group-prepend">
                                <div class="row">
                                    <div class="col">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5.784 6A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216zM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z" />
                                        </svg>
                                    </div>
                                    <div class="col">
                                        <asp:HyperLink CssClass="white-text" ID="FollowLink" runat="server"></asp:HyperLink>
                                    </div>
                                </div>
                            </div>
                        </div>
